...
class OEMStatsABC(ImproverBasePlugin):
    ...
    def _memberprocess(
        self, cube, memberfn, param_name=None, member_units=Unit("unknown"),
    ):
        ...
        for mem_cube, _ in ens_safe_slicer(cube):
            ...
            for latlong_slice in mem_cube.slices([lat_coord, lon_coord], ordered=False):
            ...
            tmp_cubelist.append(latlon_cubelist.merge_cube())
...
class BinaryProbs(OEMStatsABC):
    ...
    def process(self, cube, param_name=None, *args, **kwargs):
        ...
        return self._memberprocess(cube, memfn, param_name=param_name, member_units="1")
