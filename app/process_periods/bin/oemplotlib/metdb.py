...
class ATDNETObs(SiteObsABC):
    """Class for retrieving MetDB ATDNET subtypes"""
...
class LEELAObs(ATDNETObs):
    """Class for retrieving MetDB LEELA subtypes

    LEELA is the replacement lightning detection system for ATDNET.
    Other than the SUBTYPE name, the MetDB elements and retrieval process
    are the same as ATDNET.
    """
